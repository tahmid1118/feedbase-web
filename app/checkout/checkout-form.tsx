...
import { planIntentQuery, type PlanIntent } from "@/lib/plan-intent";
...
export function CheckoutForm({
  /** Verified plan intent from the page — the signed token is decoded server-side. */
  intent = null,
  /** The same intent re-signed, for links that need to carry it onward. */
  planToken = null,
}: {
  ...
  }, [authStatus, session, token, intent, plan, planToken, router]);
